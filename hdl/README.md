...
| [icesugar.v](hx8kdemo.v)        | FPGA-based example implementation on iCEBreaker Board           |
| [icesugar.pcf](hx8kdemo.pcf)    | Pin constraints for implementation on iCEBreaker Board          |
| [icesugar\_tb.v](hx8kdemo_tb.v) | Testbench for implementation on iCEBreaker Board                |
